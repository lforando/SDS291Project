...
The purpose of our project is to estimate a male individual's neck circumference based on their age, weight, wrist size, bicep size, and height. The data set "bodyfat" was used, and includes various body circumference measurements for 252 men between the ages of 22 and 81. Our group was interested in analzying whether or not their was a relationship between anticipated neck size and age, weight, wrist circumference, bicept circumference, and height. Based on our statistical analysis, we found that weight, wrist circumference, and bicept circumference are good predictors of one's neck circumference; whereas age and height are not as good of predictors for neck circumference. Our regression model having weight, wrist circumference, and bicept circumference as the predictor variables had the smaller of the two p-values was compared to the regression model including age but not height (p-value = 0.03058) and when compared to the full model (p-value = 0.09383). Overall, the higher a man’s weight, bicep and wrist circumference are, the larger his predicted neck size will be. 
